...
<form action="/${updateConfigUrl}" method="post" id="update-form">
    <table align='center'>
        <tr>
            <td>dataId:</td>
            <td>
               <input readonly="true" type='text' name='dataId' value="${configInfo.dataId}" width="384" class="required max-length-128" />
            </td>
        </tr>
        <tr>
            <td>group:</td>
            <td> <input type='text' readonly="true" name='group' value="${configInfo.group}" width="384" class="required max-length-128"/></td>
        </tr>
         <tr>
         ...
         <tr>  
            <td colspan="2">
               <textarea cols="150" rows="30" name="content" class="required max-length-65535"><c:out value="${configInfo.content}"/></textarea>
            </td>
        </tr>
        <tr> 
